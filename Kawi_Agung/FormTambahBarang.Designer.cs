namespace Kawi_Agung
{
	partial class FormTambahBarang
	{
		...
		private void InitializeComponent()
		{
			...
			this.textBoxTambahBarangKodeBarang = new System.Windows.Forms.TextBox();
			this.textBoxTambahBarangNamaBarang = new System.Windows.Forms.TextBox();
			this.comboBoxTambahBarangJenisBarang = new System.Windows.Forms.ComboBox();
			this.comboBoxTambahBarangKategoriBarang = new System.Windows.Forms.ComboBox();
			this.comboBoxTambahBarangMerekBarang = new System.Windows.Forms.ComboBox();
			this.numericUpDownTambahBarangHargaJual = new System.Windows.Forms.NumericUpDown();
			this.numericUpDownTambahBarangDiskon = new System.Windows.Forms.NumericUpDown();
			this.labelTambahBarangPersen = new System.Windows.Forms.Label();
			this.pictureBoxTambahBarangGambarBarang = new System.Windows.Forms.PictureBox();
			...
			// 
			// comboBoxTambahBarangJenisBarang
			// 
			...
			// 
			// comboBoxTambahBarangKategoriBarang
			// 
			...
			// 
			// comboBoxTambahBarangMerekBarang
			// 
			...
			// 
			this.numericUpDownTambahBarangHargaJual.Location = new System.Drawing.Point(221, 237);
			this.numericUpDownTambahBarangHargaJual.Maximum = new decimal(new int[] {
            999999999,
            0,
            0,
            0});
			this.numericUpDownTambahBarangHargaJual.Name = "numericUpDownTambahBarangHargaJual";
			this.numericUpDownTambahBarangHargaJual.Size = new System.Drawing.Size(181, 20);
			this.numericUpDownTambahBarangHargaJual.TabIndex = 73;
			// 
			// numericUpDownTambahBarangDiskon
			// 
			this.numericUpDownTambahBarangDiskon.Location = new System.Drawing.Point(187, 263);
			this.numericUpDownTambahBarangDiskon.Maximum = new decimal(new int[] {
            99,
            0,
            0,
            0});
			this.numericUpDownTambahBarangDiskon.Name = "numericUpDownTambahBarangDiskon";
			this.numericUpDownTambahBarangDiskon.Size = new System.Drawing.Size(38, 20);
			this.numericUpDownTambahBarangDiskon.TabIndex = 75;
			this.numericUpDownTambahBarangDiskon.KeyDown += new System.Windows.Forms.KeyEventHandler(this.numericUpDownTambahBarangDiskon_KeyDown);
			// 
			...
			this.labelTambahBarangPersen.Location = new System.Drawing.Point(231, 263);
			...
			this.pictureBoxTambahBarangGambarBarang.TabIndex = 65;
			this.pictureBoxTambahBarangGambarBarang.TabStop = false;
			// 
			// label5
			// 
			...
			this.labelHasilHargaJual.Location = new System.Drawing.Point(183, 286);
			...
			this.buttonTambahBarang.Location = new System.Drawing.Point(221, 325);
			...
			this.buttonTambahBarang.TabIndex = 67;
			...
			this.buttonUnggahFotoBarang.TabIndex = 66;
			...
			this.Controls.Add(this.numericUpDownTambahBarangDiskon);
			this.Controls.Add(this.numericUpDownTambahBarangHargaJual);
			this.Controls.Add(this.comboBoxTambahBarangMerekBarang);
			this.Controls.Add(this.comboBoxTambahBarangKategoriBarang);
			this.Controls.Add(this.comboBoxTambahBarangJenisBarang);
			this.Controls.Add(this.textBoxTambahBarangNamaBarang);
			this.Controls.Add(this.textBoxTambahBarangKodeBarang);
			this.Controls.Add(this.buttonTambahBarang);
			this.Controls.Add(this.buttonUnggahFotoBarang);
			this.Controls.Add(this.pictureBoxTambahBarangGambarBarang);
		...
		private System.Windows.Forms.PictureBox pictureBoxTambahBarangGambarBarang;
		...
		private System.Windows.Forms.TextBox textBoxTambahBarangKodeBarang;
		private System.Windows.Forms.TextBox textBoxTambahBarangNamaBarang;
		private System.Windows.Forms.ComboBox comboBoxTambahBarangJenisBarang;
		private System.Windows.Forms.ComboBox comboBoxTambahBarangKategoriBarang;
		private System.Windows.Forms.ComboBox comboBoxTambahBarangMerekBarang;
		private System.Windows.Forms.NumericUpDown numericUpDownTambahBarangHargaJual;
		private System.Windows.Forms.NumericUpDown numericUpDownTambahBarangDiskon;
